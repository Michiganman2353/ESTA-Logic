  ...
  return (
    <div className="compliance-dashboard">
      ...
      <div className="compliance-health-card">
        <div
          className={`health-status ${complianceData.isCompliant ? 'compliant' : 'needs-attention'}`}
        >
      ...
      {complianceData.nextAction && (
        <div className="next-action-card">
          ...
          <div className="action-content">
            ...
            <button className="btn-primary">Complete This Action →</button>
          </div>
        </div>
      )}
        ...
        <div className="no-action-card">
          ...
          <div className="no-action-content">
            ...
            <p className="no-action-description">
              No action required right now. We'll notify you if anything needs
              attention.
            </p>
          </div>
        </div>
      ...
      <div className="dashboard-footer">
        <div className="footer-message">
          ...
          <span className="footer-text">
            Your compliance data is automatically monitored and securely backed
            up.
          </span>
        </div>
      </div>
