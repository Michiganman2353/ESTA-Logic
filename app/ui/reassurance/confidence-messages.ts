...
export class ConfidenceMessages {
  ...
  static welcome = {
    employer: {
      ...
      secondary: "We'll walk you through Michigan ESTA compliance one clear step at a time.",
      tone: 'reassuring' as const,
      icon: '👋'
    },
    employee: {
      primary: "Welcome! Let's get you connected.",
      secondary: "Your employer uses ESTA-Logic to track your earned sick time. This will only take a minute.",
      tone: 'reassuring' as const,
      icon: '👋'
    },
    returning: {
  ...
  static progress = {
    started: {
      primary: "Great start!",
      secondary: "You're making progress. We're here to guide you every step of the way.",
      tone: 'encouraging' as const,
      icon: '✨'
    },
    halfway: {
  ...
  static success = {
    ...
    journeyCompleted: {
      primary: "🎉 All set!",
      secondary: "You're now fully compliant with Michigan ESTA requirements. We'll take it from here.",
      tone: 'celebratory' as const,
      icon: '🎉'
    },
    dataVerified: {
    ...
    employeeLinked: {
      ...
      secondary: "You're now linked to your employer's account. Your sick time tracking is active.",
      tone: 'celebratory' as const,
      icon: '🔗'
    }
  };
  ...
  static guidance = {
    employeeCount: {
      ...
      secondary: "Michigan ESTA has different rules for small (<10) and large (≥10) employers. This determines your accrual caps.",
    ...
    accrualRate: {
      ...
      secondary: "Under Michigan ESTA, employees earn 1 hour of sick time for every 30 hours worked.",
      action: "See examples",
      tone: 'supportive' as const,
      icon: '💡'
    },
    documentUpload: {
      ...
      secondary: "We use bank-level encryption to protect your files. Only authorized users can access them.",
      tone: 'reassuring' as const,
      icon: '🔒'
    },
    policySetup: {
      primary: "We'll configure the right policy for you",
      secondary: "Based on your company size, we'll automatically set the correct accrual caps and carryover rules.",
      tone: 'supportive' as const,
      icon: '⚙️'
    }
  };
  ...
  static security = {
    encrypted: {
      ...
      secondary: "We use the same security as banks to protect your information.",
      tone: 'reassuring' as const,
      icon: '🔒'
    },
    audited: {
  ...
  static completion = {
    employerOnboarding: {
      ...
      secondary: "You're all set up. Your employees can now link their accounts and track their sick time.",
    ...
    employeeOnboarding: {
      ...
      secondary: "Your sick time is now being tracked automatically. You can check your balance anytime.",
    ...
    documentSubmitted: {
      ...
      secondary: "Your document has been securely uploaded and will be reviewed shortly.",
      tone: 'reassuring' as const,
      icon: '✓'
    }
  };
  ...
  static errorRecovery = {
    connectionIssue: {
      ...
      secondary: "No worries - we saved your progress. Try again when you're back online.",
      action: "Retry",
      tone: 'supportive' as const,
      icon: '🔄'
    },
    validationFailed: {
      ...
      secondary: "We found some items that need your attention. No problem - we'll help you fix them.",
    ...
    sessionExpired: {
      ...
      secondary: "For security, we logged you out. Your progress is saved - just log back in to continue.",
      action: "Log in",
      tone: 'supportive' as const,
      icon: '🔐'
    },
    unknownError: {
      ...
      secondary: "Don't worry - your progress is saved. Please try again, or contact support if this continues.",
      action: "Try again",
      tone: 'supportive' as const,
      icon: '⚠️'
    }
