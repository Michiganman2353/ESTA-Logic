...
import { SecurityProvider, useSecurityContext } from '../SecurityContext';

// Test component that uses the context
function TestComponent() {
  const { securityState, checkSecurityStatus, recordSecurityEvent } = useSecurityContext();
  
  return (
    <div>
      <div data-testid="encryption-active">{String(securityState.encryptionActive)}</div>
      <div data-testid="audit-active">{String(securityState.auditLoggingActive)}</div>
