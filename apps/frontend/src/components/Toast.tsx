...
function ToastItem({ toast, onClose }: ToastItemProps) {
  ...
  return (
    <div
      className={` ${colors[toast.type]} animate-slide-in-right pointer-events-auto flex max-w-md items-start gap-3 rounded-lg border-l-4 p-4 shadow-lg backdrop-blur-sm`}
      role="alert"
    >
      ...
      <button
        ...
        className="flex-shrink-0 rounded p-1 text-current opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-current"
