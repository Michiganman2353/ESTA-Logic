# Strategic Reset Summary

## Executive Summary

ESTA-Logic has completed a formal strategic direction reset, transitioning from a technology-first platform to a **TurboTax-style guided compliance experience**.
...
ESTA-Logic will guide employers and employees through Michigan Earned Sick Time compliance with:

- ✅ **Clarity** — Plain language, no legal jargon
- ✅ **Confidence** — Trust-building at every step
- ✅ **Simplicity** — Complex law made easy
- ✅ **Reassurance** — "You are safe" messaging

## Five Key Principles

1. **Guided, not exploratory** — Structured steps, not chaotic menus
2. **Confidence-driven, not tech-driven** — Emotional reassurance first
3. **Simple on the surface, powerful underneath** — Hide complexity
4. **Emotionally calm and predictable** — Compliance without overwhelm
5. **Architecture serves experience** — Not dominates it
...
4. **GuidedFlowEngine Concept** (`docs/GuidedFlowEngine.md`)
...
- 🎯 [Experience Vision](./Experience-Vision.md)
- 🎨 [UX Blueprint](./UX-Blueprint.md)
- ⚙️ [GuidedFlowEngine](./GuidedFlowEngine.md)
- 🏗️ [Experience-First Architecture](./Experience-First-Architecture.md)
