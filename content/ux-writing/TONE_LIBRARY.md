# ESTA Tracker Tone Library

## Overview

This document defines ESTA Tracker's voice and tone — the personality that comes through in every word we write. Our tone is the emotional inflection of our brand voice, adapting to context while maintaining core characteristics.

**Purpose**: Ensure every word written in ESTA Tracker sounds like it comes from the same trusted, empowering partner.
...
- **Trustworthy** — "We've got your back"
- **Partnership-Oriented** — "Let's do this together"
...
**Emotional State**: Uncertain, possibly overwhelmed  
...
✅ "Welcome! We're here to make Michigan sick time compliance effortless."
✅ "No worries if you're not sure about something — we'll explain as we go."
```

### During Tasks (Guided Flows)

**Emotional State**: Focused, cautiously optimistic  
...
✅ "Good news: as a small employer, you have simpler rules."
✅ "💡 Why we ask this: [contextual explanation]"
```

### Success States

**Emotional State**: Relieved, proud  
...
✅ "Perfect! Your employees can now view their balances."
✅ "You've successfully uploaded 8 employees. Great work!"
```

### Error States

**Emotional State**: Frustrated, possibly anxious  
...
✅ "Hmm, we couldn't connect. We'll retry automatically in a few seconds."
✅ "This field needs a bit more information. Here's what we're looking for..."
```

### Security & Trust Moments

**Emotional State**: Cautious, evaluating  
...
### Complex or Technical Situations

**Emotional State**: Potentially overwhelmed  
...
✅ "Here's what this means for you: [practical implication]"
✅ "Don't worry about the legal details — we've got that covered."
```

### Empty or First-Use States
...
✅ "No sick time tracked yet. That's normal — we'll start counting once you add hours."
✅ "Ready to begin? Click here to start your guided setup."
```
...
❌ Bad:
Your policy includes accrual at 1 hour per 30 worked with a maximum of 40 hours per year and carryover up to 40 hours.
```
...
❌ "The user's setup is complete"
❌ "System has processed calculations"
```
...
**Field labels should be questions or clear requests**:
...
✅ "When did you start operating in Michigan?"
❌ "Establishment Date"
```
...
- [ ] **Tone**: Does it match the user's emotional state?
- [ ] **Clarity**: Can an 8th grader understand it?
- [ ] **Voice**: Does it sound like ESTA Tracker (reassuring, clear, empowering)?
- [ ] **Action**: Does it guide the user forward?
- [ ] **Trust**: Does it build confidence?
- [ ] **Simplicity**: Is it as short as possible while being clear?
...
- **[UX Content Library README](./README.md)** - Overview of this library
- **[User Experience Vision](../../USER_EXPERIENCE_VISION.md)** - Complete UX philosophy
- **[Design Tone Guide](../../docs/Design-Tone-Guide.md)** - Additional tone guidance

---

## 🎓 Quick Reference

**When writing for ESTA Tracker, always ask**:

1. **Does this reduce anxiety or increase it?**
2. **Is this as clear as it can be?**
3. **Does this empower the user or talk down to them?**
4. **Does this build trust or create doubt?**
5. **Does this feel like a partner or a vendor?**

If the answer to any is "wrong direction," rewrite.
