...
Emotional UX Patterns organize copy and messaging by the user's emotional journey — not just by UI component. This document maps specific copy patterns to emotional states, ensuring every interaction builds trust, reduces anxiety, and guides users toward confidence.
...
```
😰 Fear/Uncertainty  →  🤔 Curiosity  →  😌 Relief  →  ✅ Confidence  →  💚 Advocacy
...
Trust Signal:
"🛡️ 1,200+ Michigan businesses • Bank-level security • ESTA law verified"

Primary CTA:
"Get Started Free →"

Value Proposition:
"In 15 minutes, you'll go from confused to compliant — guaranteed."
```
...
Status Display:
"Your compliance status: ✅ Excellent (98%)"
...
"💡 Heads up: Annual carryover review due in 30 days"
```
...
⏸️ Take breaks anytime — we'll be here when you get back"
```
...
✅ "Great choice — as a small employer, you'll have simpler rules"
...
Saved Confirmation:
"✅ Saved" (brief display, fades)

Save Error:
"Couldn't save — will retry" (persistent until resolved)
...
Alternative:
"Need to start over? Start from the beginning →"
```
...
🔍 Want to see the math? Click to view detailed breakdown"
...
98-100%: "Excellent — you're essentially bulletproof"
90-97%:  "Very Good — minor items to address"
80-89%:  "Good — a few areas need attention"
<80%:    "Needs Attention — let's fix these items"
...
✅ Accrual calculations with methodology
✅ Usage history with documentation
✅ Policy compliance verification
✅ Legal references to Michigan ESTA law"
...
• Employee can use some time first
...
⏰ Total Accrual: ${hours} hours across ${employees} employees
📝 PTO Requests: ${requests} (all processed)
✅ Audit Readiness: 100%
